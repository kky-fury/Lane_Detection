...
#define ROI_IMAGE_HEIGHT 384
#define NUMPIX	(IMAGE_WIDTH*IMAGE_HEIGHT)
#define THREAD_X 16
#define THREAD_Y 16
#define COLUMN_INDEX (0.95*IMAGE_WIDTH)
#define ROW_INDEX (0.95*IMAGE_HEIGHT)
...
//unsigned char* convert2Gray(const unsigned char* const rgbImage);
